...
if("TRUE" STREQUAL "TRUE")
  set(main_SOURCE_PREFIX /home/rtk/RSE/Robotics_ND_Udacity/project3/EKF_lab/src/main)
  set(main_DEVEL_PREFIX /home/rtk/RSE/Robotics_ND_Udacity/project3/EKF_lab/devel)
  set(main_INSTALL_PREFIX "")
  set(main_PREFIX ${main_DEVEL_PREFIX})
else()
  set(main_SOURCE_PREFIX "")
  set(main_DEVEL_PREFIX "")
  set(main_INSTALL_PREFIX /home/rtk/RSE/Robotics_ND_Udacity/project3/EKF_lab/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'rtk <rtk@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'main' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rtk/RSE/Robotics_ND_Udacity/project3/EKF_lab/src/main/${idir}'.  ${_report}")
    endif()
